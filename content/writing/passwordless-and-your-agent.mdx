...
If you want to play with it, I built [Identity Lab](https://identity.marwandiallo.com) — a hands-on demo that walks through the WebAuthn ceremony, the JWT failure modes, and the agent-identity gap, with working code. It's the lab I wish I'd had ten years ago.
